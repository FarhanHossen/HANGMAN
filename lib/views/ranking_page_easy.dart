...
class RankingPageEasy extends StatelessWidget {
  final List<Users> easyUsers;
  const RankingPageEasy({Key? key, required this.easyUsers}) : super(key: key);
