...
class RankingPageMedium extends StatelessWidget {
  final List<Users> mediumUsers;
  const RankingPageMedium({Key? key, required this.mediumUsers})
      : super(key: key);
